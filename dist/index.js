...
var toc_inline_default = 'var a=new IntersectionObserver(t=>{for(let o of t){let c=o.target.id,e=document.querySelectorAll(`a[data-for="${c}"]`),s=o.rootBounds?.height;s&&e.length>0&&(o.boundingClientRect.y<s?e.forEach(n=>n.classList.add("in-view")):e.forEach(n=>n.classList.remove("in-view")))}});function l(t){t.classList.add("collapsed"),t.setAttribute("aria-expanded","false"),document.documentElement.classList.remove("toc-lock-scroll","toc-mobile-no-scroll")}function m(t){document.querySelectorAll(".explorer:not(.collapsed)").forEach(c=>{c.classList.add("collapsed"),c.setAttribute("aria-expanded","false"),document.documentElement.classList.remove("mobile-no-scroll","lock-scroll")}),t.classList.remove("collapsed"),t.setAttribute("aria-expanded","true"),document.documentElement.classList.add("toc-lock-scroll","toc-mobile-no-scroll")}function u(){let t=Array.from(document.querySelectorAll(".toc"));for(let e of t){let s=e.querySelector("button.toc-header.desktop-toc");if(s){let i=function(){this.classList.toggle("collapsed"),this.setAttribute("aria-expanded",this.getAttribute("aria-expanded")==="true"?"false":"true");let d=this.nextElementSibling;d&&d.classList.toggle("collapsed")};s.addEventListener("click",i),window.addCleanup?.(()=>s.removeEventListener("click",i))}let n=e.querySelector("button.mobile-toc");if(!n)continue;n.classList.remove("hide-until-loaded"),n.checkVisibility?.()&&l(e);let r=function(){e.classList.contains("collapsed")?m(e):l(e)};n.addEventListener("click",r),window.addCleanup?.(()=>{n.removeEventListener("click",r),l(e)})}let o=()=>{document.querySelectorAll(".toc").forEach(e=>l(e))};document.addEventListener("prenav",o),window.addCleanup?.(()=>document.removeEventListener("prenav",o)),a.disconnect(),document.querySelectorAll("h1[id], h2[id], h3[id], h4[id], h5[id], h6[id]").forEach(e=>a.observe(e))}var p=document.querySelectorAll(".explorer-toggle");p.forEach(t=>{let o=()=>{document.querySelector(".explorer")?.classList.contains("collapsed")&&document.querySelectorAll(".toc").forEach(e=>l(e))};t.addEventListener("click",o),window.addCleanup?.(()=>t.removeEventListener("click",o))});document.addEventListener("nav",u);document.addEventListener("render",u);\n';
